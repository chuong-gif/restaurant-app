...
import type { RootState } from "../store"; // ✅ FIXED: Import RootState
...
export const fetchBlogSuccess = (data: BlogListResponse): BlogAction => ({
...
export const fetchBlog =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const response: AxiosResponse<BlogListResponse> = await http.get(url.toString());
